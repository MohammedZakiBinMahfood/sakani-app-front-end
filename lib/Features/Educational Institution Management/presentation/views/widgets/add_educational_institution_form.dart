...
class AddEducationalInstitutionForm extends StatefulWidget {
  const AddEducationalInstitutionForm({
    super.key,
  });

  @override
  State<AddEducationalInstitutionForm> createState() =>
      _AddEducationalInstitutionFormState();
}

class _AddEducationalInstitutionFormState
    extends State<AddEducationalInstitutionForm> {
      ...
      child: Column(
        children: [
          ...
          CustomTextFormField(
            ...
            validator: (value) =>
                validateTextField(value, 1, 30, "Educational Institution Name"),
          ),
